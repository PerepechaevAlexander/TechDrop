...
public sealed class TechDropDbContext : DbContext
{
    ...
    public TechDropDbContext()
    {
        if (Database.EnsureCreated())
        {
            ...
            OrderStatus osOpened = new OrderStatus { Name = "Открыт" };
            OrderStatus osAccepted = new OrderStatus { Name = "Заказ принят" };
            OrderStatus osAssembly = new OrderStatus { Name = "Заказ на сборке" };
            OrderStatus osDelivery = new OrderStatus { Name = "Заказ передан в службу доставки" };
            OrderStatus osCame = new OrderStatus { Name = "Заказ в пункте выдачи" };
            OrderStatus osClosed = new OrderStatus { Name = "Завершен" };
            OrderStatus osCancelled = new OrderStatus { Name = "Отменен" };
            OrderStatuses.AddRange(osOpened, osAccepted, osAssembly, osDelivery, osCame, osClosed, osCancelled);

            RamType rtDdr3 = new RamType { Name = "DDR3" };
            RamType rtDdr4 = new RamType { Name = "DDR4" };
            RamType rtDdr5 = new RamType { Name = "DDR5" };
            RamTypes.AddRange(rtDdr3, rtDdr4, rtDdr5);

            PciExpress pe3 = new PciExpress { Name = "PCI-E 3.0" };
            PciExpress pe4 = new PciExpress { Name = "PCI-E 4.0" };
            PciExpress pe5 = new PciExpress { Name = "PCI-E 5.0" };
            PciExpresses.AddRange(pe3, pe4, pe5);

            Socket sAm4 = new Socket { Name = "AM4" };
            Socket sAm5 = new Socket { Name = "AM5" };
            Socket sLga1200 = new Socket { Name = "LGA 1200" };
            Socket sLga1700 = new Socket { Name = "LGA 1700" };
            Socket ssWrx8 = new Socket { Name = "sWRX8" };
            Socket sLga2066 = new Socket { Name = "LGA 2066" };
            Sockets.AddRange(sAm4, sAm5, sLga1200, sLga1700, ssWrx8, sLga2066);

            GraphCore gcVega3 = new GraphCore
                { Model = "AMD Radeon Vega 3", MaxFrequency = 1100, ExecutiveBlocks = 3, ShadingUnits = 192 };
            GraphCores.AddRange(gcVega3);


            ProductCategory pcProcessor = new ProductCategory
            {
                Name = "Процессоры", Picture = FileConverter.GetBinaryFile(@"..\TechDrop.Data\src\categories\processor.png")
            };
            ProductCategory pcMotherboard = new ProductCategory
            {
                Name = "Материнские платы", Picture = FileConverter.GetBinaryFile(@"..\TechDrop.Data\src\categories\motherboard.png")
            };
            ProductCategory pcVideocard = new ProductCategory
            {
                Name = "Видеокарты", Picture = FileConverter.GetBinaryFile(@"..\TechDrop.Data\src\categories\videocard.png")
            };
            ProductCategory pcRam = new ProductCategory
            {
                Name = "Оперативная память", Picture = FileConverter.GetBinaryFile(@"..\TechDrop.Data\src\categories\ram.png")
            };
            ProductCategory pcRom = new ProductCategory
            {
                Name = "Жёсткие диски", Picture = FileConverter.GetBinaryFile(@"..\TechDrop.Data\src\categories\rom.png")
            };
            ProductCategory pcCase = new ProductCategory
            {
            ...
            User userPsn = new User { Email = "psn@ya.ru", Password = "123123", Balance = 0 };
            ...
            Processor prAthlon3000G = new Processor
            {
                Model = "Athlon 3000G",
            ...
            Processor prI310105F = new Processor
            {
            ...
            Processor prRyzen54500 = new Processor
            {
                Model = "Ryzen 5 4500",
                SocketId = sAm4.SocketId,
                Year = 2019,
            ...
            Processor prI312100F = new Processor
            {
            ...
            ProcessorRamType prt1 = new ProcessorRamType
            {
            ...
            ProcessorRamType prt2 = new ProcessorRamType
            {
            ...
            ProcessorRamType prt3 = new ProcessorRamType
            {
            ...
            ProcessorRamType prt4 = new ProcessorRamType
            {
            ...
            ProcessorRamType prt5 = new ProcessorRamType
            {
                ProcessorId = prI312100F.ProcessorId,
            ...
            Product athlon3000G = new Product
            {
                Description =
            ...
            Product ryzen54500 = new Product
            {
                Description =
            ...
            ProductPicture picAthlon3000G = new ProductPicture
            {
            ...
            ProductPicture picI310105F = new ProductPicture
            {
            ...
            ProductPicture picRyzen54500 = new ProductPicture
            {
            ...
            ProductPicture picI312100F = new ProductPicture
            {
            ...
            OrderProduct opPsn1 = new OrderProduct
            {
                ProductId = athlon3000G.ProductId,
                Quantity = 1,
            ...
            OrderProduct opPsn2 = new OrderProduct
            {
                ProductId = i310105F.ProductId,
                Quantity = 1,
                OrderId = oPsn1.OrderId,
